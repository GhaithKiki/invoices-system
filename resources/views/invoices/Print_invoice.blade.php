            ...
            <div class="card card-invoice">
                <div class="card-body">
                    ...
                    <div class="table-responsive mg-t-40">
                        ...
                        <tr>
                            <td colspan="7" style="font-weight: bold;">معلومات الفاتورة بعد إضافة الضريبة:</td>
                        </tr>
                                <div id="total-5">
                                    <tr>

                                        <td class="tx-right">الاجمالي</td>
                                        <td class="tx-right" colspan="1"> {{ number_format($total, 2) }}</td>
                                    </tr>
                                    <tr>
                                        <td class="tx-right">نسبة الضريبة ({{ $invoices->Rate_VAT }})</td>
                                        <td class="tx-right" colspan="1">287.50</td>
                                    </tr>
                                    <tr>
                                        <td class="tx-right">قيمة الخصم</td>
                                        <td class="tx-right" colspan="1"> {{ number_format($invoices->Discount, 2) }}</td>
