...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/' . ($page = 'index')) }}"><img
                src="{{ URL::asset('assets/img/brand/g.png') }}" class="main-logo" alt="logo"></a>
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('assets/img/faces/gh.png') }}"><span
            ...
            @can('الفواتير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . $page='Archive_invoices') }}">أرشفة الفواتير</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
